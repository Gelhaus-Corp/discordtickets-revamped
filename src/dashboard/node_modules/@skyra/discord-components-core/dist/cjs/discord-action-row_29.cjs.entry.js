...
const index = require('./index-e5e4d9b4.js');
...
const DiscordBold = class {
  ...
  render() {
    return (index.h("strong", null, index.h("slot", null)));
  }
};
...
const DiscordCustomEmoji = class {
  ...
  render() {
    ...
    return (index.h("span", { class: emojiClassName }, index.h("img", { "aria-label": name, src: this.url, alt: name, draggable: false, class: emojiImageClassName })));
  }
  get el() { return index.getElement(this); }
};
...
const DiscordEmbed = class {
  ...
  parseTitle(title) {
    ...
    return words.map((word, idx) => {
      ...
      let el = '';
      if (emoji.name) {
        el = (index.h("span", { class: "discord-embed-custom-emoji" }, index.h("img", { src: emoji.url, alt: emoji.name, class: "discord-embed-custom-emoji-image" }), index.h("span", null, "\u00A0")));
      }
      else {
...
const DiscordEmbedDescription = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: "discord-embed-description" }, index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
...
const DiscordEmbedField = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: clsx({
      ...
      }, 'discord-embed-field') }, emojiParsedEmbedFieldTitle && index.h("div", { class: "discord-field-title" }, [...emojiParsedEmbedFieldTitle]), index.h("slot", null)));
  }
  parseTitle(title) {
    if (!title)
      return null;
...
const DiscordEmbedFooter = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: "discord-embed-footer" }, this.footerImage ? index.h("img", { src: this.footerImage, alt: "", class: "discord-footer-image" }) : '', index.h(Fragment, null, index.h("slot", null), this.timestamp ? index.h("span", { class: "discord-footer-separator" }, "\u2022") : '', this.timestamp ? index.h(Fragment, null, this.timestamp) : '')));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const DiscordInlineCode = class {
  ...
  render() {
    return (index.h("code", null, index.h("slot", null)));
  }
};
...
const DiscordItalic = class {
  ...
  render() {
    return (index.h("em", null, index.h("slot", null)));
  }
};
  ...
  render() {
    ...
    switch (this.type) {
      ...
      case 'thread':
        ...
        break;
      case 'forum':
        mentionPrepend = index.h(ChannelForum, { class: "discord-mention-icon" });
        break;
      case 'slash':
        mentionPrepend = '/';
        break;
...
const AuthorInfo = ({ author, bot, server, op, roleColor, roleIcon, roleName, verified, compact }) => (index.h("span", { class: "discord-author-info" },
  !compact && (index.h(Fragment, null,
    index.h("span", { class: "discord-author-username", style: { color: roleColor } }, author),
    roleIcon && index.h("img", { class: "discord-author-role-icon", src: roleIcon, height: "20", width: "20", alt: roleName, draggable: false }))),
  index.h(Fragment, null,
    ...
    op && index.h("span", { class: "discord-application-tag discord-application-tag-op" }, "OP")),
  compact && (index.h("span", { class: "discord-author-username", style: { color: roleColor } }, author))));

function Ephemeral(props) {
  return (index.h("svg", Object.assign({}, props, { "aria-hidden": "false", width: "16", height: "16", viewBox: "0 0 24 24" }),
    index.h("path", { fill: "currentColor", d: "M12 5C5.648 5 1 12 1 12C1 12 5.648 19 12 19C18.352 19 23 12 23 12C23 12 18.352 5 12 5ZM12 16C9.791 16 8 14.21 8 12C8 9.79 9.791 8 12 8C14.209 8 16 9.79 16 12C16 14.21 14.209 16 12 16Z" }),
    index.h("path", { fill: "currentColor", d: "M12 14C13.1046 14 14 13.1046 14 12C14 10.8954 13.1046 10 12 10C10.8954 10 10 10.8954 10 12C10 13.1046 10.8954 14 12 14Z" })));
}
...
const DiscordMessage = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: clsx('discord-message', {
        'discord-highlight-mention': highlightMention,
        'discord-message-has-thread': hasThread,
        'discord-highlight-ephemeral': this.ephemeral
      }) }, index.h("slot", { name: "reply" }), index.h("div", { class: "discord-message-inner" }, parent.compactMode && index.h("span", { class: "discord-message-timestamp" }, this.timestamp), index.h("div", { class: "discord-author-avatar" }, index.h("img", { src: profile.avatar, alt: profile.author })), index.h("div", { class: "discord-message-content" }, !parent.compactMode && (index.h(Fragment, null, index.h(AuthorInfo, { author: (_c = profile.author) !== null && _c !== void 0 ? _c : '', bot: (_d = profile.bot) !== null && _d !== void 0 ? _d : false, server: (_e = profile.server) !== null && _e !== void 0 ? _e : false, verified: (_f = profile.verified) !== null && _f !== void 0 ? _f : false, op: (_g = profile.op) !== null && _g !== void 0 ? _g : false, roleColor: (_h = profile.roleColor) !== null && _h !== void 0 ? _h : '', roleIcon: (_j = profile.roleIcon) !== null && _j !== void 0 ? _j : '', roleName: (_k = profile.roleName) !== null && _k !== void 0 ? _k : '', compact: parent.compactMode }), index.h("span", { class: "discord-message-timestamp" }, this.timestamp))), index.h("div", { class: "discord-message-body" }, parent.compactMode && (index.h(AuthorInfo, { author: (_l = profile.author) !== null && _l !== void 0 ? _l : '', bot: (_m = profile.bot) !== null && _m !== void 0 ? _m : false, server: (_o = profile.server) !== null && _o !== void 0 ? _o : false, verified: (_p = profile.verified) !== null && _p !== void 0 ? _p : false, op: (_q = profile.op) !== null && _q !== void 0 ? _q : false, roleColor: (_r = profile.roleColor) !== null && _r !== void 0 ? _r : '', roleIcon: (_s = profile.roleIcon) !== null && _s !== void 0 ? _s : '', roleName: (_t = profile.roleName) !== null && _t !== void 0 ? _t : '', compact: parent.compactMode })), index.h("span", { class: "discord-message-markup" }, index.h("slot", null)), this.edited ? index.h("span", { class: "discord-message-edited" }, "(edited)") : ''), index.h("div", { class: "discord-message-compact-indent" }, index.h("slot", { name: "embeds" }), index.h("slot", { name: "attachments" }), index.h("slot", { name: "components" }), index.h("slot", { name: "reactions" }), index.h("slot", { name: "thread" }), this.ephemeral && (index.h("div", { class: "discord-message-ephemeral" }, index.h(Ephemeral, { class: "discord-message-ephemeral-icon" }), "Only you can see this \u2022 ", index.h("span", { class: "discord-message-ephemeral-link" }, "Dismiss message"))))))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "timestamp": ["updateTimestamp"]
...
const DiscordQuote = class {
  ...
  render() {
    return (index.h(index.Host, { class: "discord-quote-container" }, index.h("div", { class: "discord-quote-divider" }), index.h("blockquote", null, index.h("slot", null))));
  }
};
...
const DiscordReply = class {
  ...
  render() {
    ...
    const profile = Object.assign(Object.assign(Object.assign({}, defaultData), profileData), { avatar: resolveAvatar((_b = profileData.avatar) !== null && _b !== void 0 ? _b : this.avatar) });
    const messageParent = parent.parentElement;
    return (index.h(index.Host, { class: "discord-replied-message" }, messageParent.compactMode ? (index.h("div", { class: "discord-reply-badge" }, index.h(ReplyIcon, null))) : (index.h("img", { class: "discord-replied-message-avatar", src: profile.avatar, alt: profile.author })), index.h(Fragment, null, profile.bot && !profile.server && (index.h("span", { class: "discord-application-tag" }, profile.verified && index.h(VerifiedTick, null), "Bot")), profile.server && !profile.bot && index.h("span", { class: "discord-application-tag" }, "Server"), profile.op && index.h("span", { class: "discord-application-tag discord-application-tag-op" }, "OP")), index.h("span", { class: "discord-replied-message-username", style: { color: (_c = profile.roleColor) !== null && _c !== void 0 ? _c : '' } }, this.mentions && '@', profile.author), index.h("div", { class: "discord-replied-message-content" }, index.h("slot", null), this.edited ? index.h("span", { class: "discord-message-edited" }, "(edited)") : ''), this.command ? (index.h(CommandReply, { class: "discord-replied-message-content-icon" })) : (this.attachment && index.h(AttachmentReply, { class: "discord-replied-message-content-icon" }))));
  }
  get el() { return index.getElement(this); }
};
...
const DiscordSpoiler = class {
  ...
  render() {
    return (index.h(index.Host, { class: "discord-spoiler" }, index.h("slot", null)));
  }
};
...
function Pin(props) {
  return (index.h("svg", Object.assign({}, props, { "aria-hidden": "false", height: "18", viewBox: "0 0 18 18", width: "18" }),
    index.h("path", { d: "m16.908 8.39684-8.29587-8.295827-1.18584 1.184157 1.18584 1.18584-4.14834 4.1475v.00167l-1.18583-1.18583-1.185 1.18583 3.55583 3.55502-4.740831 4.74 1.185001 1.185 4.74083-4.74 3.55581 3.555 1.185-1.185-1.185-1.185 4.1475-4.14836h.0009l1.185 1.185z", fill: "#b9bbbe" })));
}
...
const DiscordTime = class {
  ...
  render() {
    return (index.h(index.Host, { class: "discord-time" }, index.h("slot", null)));
  }
};
...
const DiscordUnderlined = class {
  ...
  render() {
    return (index.h("u", null, index.h("slot", null)));
  }
};
...
exports.discord_time = DiscordTime;
exports.discord_underlined = DiscordUnderlined;

//# sourceMappingURL=discord-action-row_29.cjs.entry.js.map