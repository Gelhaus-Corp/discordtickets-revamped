...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-BfxQ8j1M.js')),
			__memo(() => import('./chunks/17-D1K-aHAi.js')),
			__memo(() => import('./chunks/18-DeBKE3kM.js')),
			__memo(() => import('./chunks/19-ByZ5FHX9.js')),
			__memo(() => import('./chunks/20-Dzafyzy-.js')),
			__memo(() => import('./chunks/21-BPk2Y1MO.js')),
			__memo(() => import('./chunks/22-DO3Y6ygD.js')),
			__memo(() => import('./chunks/23-C91MQbVR.js')),
			__memo(() => import('./chunks/24-DFxrnFUW.js'))
		],
		remotes: {
