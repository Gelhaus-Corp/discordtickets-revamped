...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-gXc4q3ju.js')),
			__memo(() => import('./chunks/17-CkCYwa-j.js')),
			__memo(() => import('./chunks/18-DeBKE3kM.js')),
			__memo(() => import('./chunks/19-EHn-USYU.js')),
			__memo(() => import('./chunks/20-DmX6zHob.js')),
			__memo(() => import('./chunks/21-CHukKT6N.js')),
			__memo(() => import('./chunks/22-CnVGqb-9.js')),
			__memo(() => import('./chunks/23-ConGB3xK.js')),
			__memo(() => import('./chunks/24-D2eAZSDw.js'))
		],
		remotes: {
