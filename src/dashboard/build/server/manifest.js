...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/16-CsXPp47i.js')),
			__memo(() => import('./chunks/17-hsawt3sW.js')),
			__memo(() => import('./chunks/18-CP540K6y.js')),
			__memo(() => import('./chunks/19-DrNUheiU.js')),
			__memo(() => import('./chunks/20-Drolp8g-.js')),
			__memo(() => import('./chunks/21-BAZ-WEAZ.js')),
			__memo(() => import('./chunks/22-DyO34hUY.js')),
			__memo(() => import('./chunks/23-1HKcnNKh.js')),
			__memo(() => import('./chunks/24-DGJOmowC.js')),
			__memo(() => import('./chunks/25-Cr8ECjQd.js'))
		],
		remotes: {
