import { p as push, a1 as ensure_array_like, b as attr, a2 as stringify, g as getContext, a6 as copy_payload, a7 as bind_props, a as pop, a8 as assign_payload } from './index-7U-6WjDo.js';
import { r as run } from './legacy-server-DignnEdf.js';
...
import { q as questionsState } from './state.svelte-CZg8XtUa.js';
...
function MenuQuestion($$payload, $$props) {
  ...
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    ...
    $$payload.out += `<li>${escape_html(option.label)}</li>`;
  }
  $$payload.out += `<!--]--></ul></div></div> <div><div><label class="font-medium">Placeholder <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="The placeholder (label)"></i> <input type="text" class="input form-input text-sm" maxlength="150"${attr("value", question.placeholder)}></label></div></div>`;
  bind_props($$props, { question });
  pop();
}
function Questions($$payload, $$props) {
  push();
  let loading = {};
  let expanded = null;
  let $$settled = true;
  ...
  function $$render_inner($$payload2) {
    ...
    $$payload2.out += `<div class="list-group flex flex-col gap-2"><!--[-->`;
    for (let i = 0, $$length = each_array.length; i < $$length; i++) {
      let q = each_array[i];
      $$payload2.out += `<div${attr("data-id", q.id)} class="list-group-item rounded-xl bg-gray-100/50 p-4 dark:bg-slate-800/50"><div class="w-full"><div class="flex items-center gap-2 md:gap-4"><i class="handle fa-solid fa-grip-vertical cursor-move text-gray-500 dark:text-slate-400"></i> <div class="w-full">${escape_html(q.label)} <button type="button"${attr("disabled", loading[q.id], true)} class="text-red-300 transition duration-300 hover:text-red-500 disabled:cursor-not-allowed dark:text-red-500/50 dark:hover:text-red-500" title="Remove">`;
      if (loading[q.id]) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<i class="fa-solid fa-spinner animate-spin"></i>`;
      } else {
        $$payload2.out += "<!--[!-->";
        $$payload2.out += `<i class="fa-solid fa-xmark"></i>`;
      }
      $$payload2.out += `<!--]--></button> <button type="button" class="flex w-full cursor-pointer select-none justify-between font-medium text-gray-500 transition duration-300 hover:text-blurple dark:text-slate-400 dark:hover:text-blurple"><span class="text-sm">Click to ${escape_html(expanded === q.id ? "collapse" : "expand")}</span> <i${attr("class", `fa-solid ${stringify(expanded === q.id ? "fa-angle-up" : "fa-angle-down")} self-end text-xl`)}></i></button></div></div> `;
      if (expanded === q.id) {
        $$payload2.out += "<!--[-->";
        $$payload2.out += `<div class="my-4 text-sm"><div class="grid grid-cols-1 gap-3"><div><label class="font-medium">Type `;
        Required($$payload2);
        $$payload2.out += `<!----> <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="What type of input should the question use?"></i> <select class="input form-multiselect text-sm" required><option${attr("value", null)} class="p-1" default disabled>Select an input type</option><option value="TEXT" class="p-1">Text</option><option value="MENU" class="p-1" disabled title="Disabled until supported by Discord">Select menu</option></select></label></div> `;
        if (q.type === "TEXT") {
          $$payload2.out += "<!--[-->";
          TextQuestion($$payload2, {
            get question() {
...
function _page($$payload, $$props) {
  push();
  let { data } = $$props;
  let tmp = data, category = tmp.category, channels = tmp.channels, roles = tmp.roles;
  tmp.url;
  const slowmodes = [
    "5s",
    "10s",
  ...
  const each_array_3 = ensure_array_like(slowmodes);
  const each_array_4 = ensure_array_like(roles);
  const each_array_5 = ensure_array_like(roles);
  $$payload.out += `<div class="mb-8 text-center text-orange-600 dark:text-orange-400"><p><i class="fa-solid fa-triangle-exclamation"></i> <a href="https://discordtickets.app/configuration/categories" class="font-semibold hover:underline">Read the documentation</a> to avoid problems.</p></div> <h1 class="m-4 text-center text-4xl font-bold">Categories</h1> <h2 class="m-4 text-center text-2xl font-semibold text-gray-500 dark:text-slate-400">${escape_html(emoji.get(category.emoji) ?? "")}
	${escape_html(category.name || "New category")}</h2> <div class="m-2 mx-auto max-w-5xl p-4 text-lg">`;
  {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <form class="my-4"><div class="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-12"><div class="grid grid-cols-1 gap-8"><div><label class="font-medium">Name `;
  Required($$payload);
  $$payload.out += `<!----> <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="The name of the category"></i> <input type="text" class="input form-input" required${attr("value", category.name)}></label></div> <div><label class="font-medium">Channel name `;
  if (category.id) {
    $$payload.out += "<!--[-->";
    Required($$payload);
  } else {
  ...
  $$payload.out += `<!--]--></select></label></div> <div><label class="font-medium">Emoji `;
  Required($$payload);
  ...
  Required($$payload);
  $$payload.out += `<!----> <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="Content to be sent in the opening message of each ticket."></i> <textarea class="input form-input" required rows="4" maxlength="1000">`;
    ...
    $$payload.out += `<!---->`;
    {
      if (category.openingMessage) {
        ...
        if (category.pingRoles?.length > 0) {
          $$payload.out += "<!--[-->";
          const each_array_1 = ensure_array_like(category.pingRoles);
          $$payload.out += `<!--[-->`;
          for (let index = 0, $$length = each_array_1.length; index < $$length; index++) {
            ...
            if (role) {
              ...
              $$payload.out += `<!--]--> <discord-mention${attr("color", role?._hexColor)} type="role">${escape_html(role?.name)}</discord-mention>`;
            } else {
              $$payload.out += "<!--[!-->";
            }
            $$payload.out += `<!--]-->`;
        ...
        if (data.settings.footer) {
          $$payload.out += "<!--[-->";
          $$payload.out += `<discord-embed-footer slot="footer"${attr("footer-image", data.client.avatar)}>${escape_html(data.settings.footer)}</discord-embed-footer>`;
        } else {
          $$payload.out += "<!--[!-->";
        }
        $$payload.out += `<!--]--></discord-embed> <discord-attachments slot="components"><discord-action-row>`;
        if (category.requireTopic || questionsState.questions.length > 0) {
          $$payload.out += "<!--[-->";
          $$payload.out += `<discord-button type="secondary">✏️ Edit</discord-button>`;
        } else {
          $$payload.out += "<!--[!-->";
        }
        $$payload.out += `<!--]--> `;
        if (category.claiming && data.settings.claimButton) {
          $$payload.out += "<!--[-->";
          $$payload.out += `<discord-button type="secondary">🙌 Claim</discord-button>`;
        } else {
          $$payload.out += "<!--[!-->";
        }
        $$payload.out += `<!--]--> `;
        if (data.settings.closeButton) {
          $$payload.out += "<!--[-->";
          $$payload.out += `<discord-button type="destructive">✖️ Close</discord-button>`;
        } else {
          $$payload.out += "<!--[!-->";
        }
        $$payload.out += `<!--]--></discord-action-row></discord-attachments></discord-message></discord-messages>`;
      } else {
        $$payload.out += "<!--[!-->";
      }
      $$payload.out += `<!--]-->`;
  ...
  $$payload.out += `<!----></div> <div><label class="font-medium">Ping roles <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="Roles that should be pinged upon ticket creation."></i> <select multiple class="input form-multiselect h-44 font-normal"><!--[-->`;
  ...
  $$payload.out += `<!--]--></select></label></div> <div><label class="font-medium">Slow mode <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="Should slow mode be enabled?"></i> <select class="input form-multiselect font-normal"><option${attr("value", null)} class="p-1">Off</option><!--[-->`;
  for (let $$index_3 = 0, $$length = each_array_3.length; $$index_3 < $$length; $$index_3++) {
    let slowmode = each_array_3[$$index_3];
    $$payload.out += `<option${attr("value", ms(slowmode) / 1e3)} class="p-1">${escape_html(slowmode)}</option>`;
  }
  $$payload.out += `<!--]--></select></label></div> <div><label class="font-medium">Required roles <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="Roles that a user needs to create a ticket."></i> <select multiple class="input form-multiselect h-44 font-normal"><!--[-->`;
  for (let $$index_4 = 0, $$length = each_array_4.length; $$index_4 < $$length; $$index_4++) {
    let role = each_array_4[$$index_4];
    $$payload.out += `<option${attr("value", role.id)} class="m-1 rounded p-1"${attr("style", role._style)}>${escape_html(role.unicodeEmoji || "")}
									${escape_html(role.name)}</option>`;
  }
  $$payload.out += `<!--]--></select></label></div> <div><label for="requireTopic" class="font-medium">Require topic <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="Require a topic before ticket creation?"></i> <input type="checkbox" id="requireTopic" name="requireTopic" class="form-checkbox"${attr("disabled", questionsState.questions.length > 0, true)}${attr("checked", category.requireTopic, true)}></label></div> <div><label class="font-medium">Staff roles `;
  Required($$payload);
  $$payload.out += `<!----> <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="Roles that will be able to view tickets."></i> <select multiple required class="input form-multiselect h-44 font-normal"><!--[-->`;
  for (let $$index_5 = 0, $$length = each_array_5.length; $$index_5 < $$length; $$index_5++) {
    let role = each_array_5[$$index_5];
    $$payload.out += `<option${attr("value", role.id)} class="m-1 rounded p-1"${attr("style", role._style)}>${escape_html(role.unicodeEmoji || "")}
									${escape_html(role.name)}</option>`;
  }
  $$payload.out += `<!--]--></select></label></div> <div><label class="font-medium">Total limit <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="The total number of tickets that can be open at once."></i> <input type="number" min="1" max="50" class="input form-input"${attr("value", category.totalLimit)}></label></div></div> <div><div class="rounded-xl bg-white p-4 shadow-sm dark:bg-slate-700"><div class="flex flex-col gap-4"><div class="text-center"><h3 class="text-xl font-bold">Questions</h3> <p class="text-gray-500 dark:text-slate-400">${escape_html(questionsState.questions.length)}/5</p></div> `;
  if (questionsState.questions.length > 0) {
    $$payload.out += "<!--[-->";
    const each_array_6 = ensure_array_like(questionsState.questions);
    $$payload.out += `<div><label class="font-medium">Custom topic <i class="fa-solid fa-circle-question cursor-help text-gray-500 dark:text-slate-400" title="Which question's value should be used as the ticket topic?"></i> <select class="input form-multiselect font-normal"><option${attr("value", null)} class="p-1">None</option><hr><!--[-->`;
    for (let $$index_6 = 0, $$length = each_array_6.length; $$index_6 < $$length; $$index_6++) {
      let q = each_array_6[$$index_6];
      $$payload.out += `<option${attr("value", q.id)} class="p-1">${escape_html(q.label)}</option>`;
    }
    $$payload.out += `<!--]--></select></label></div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <div>`;
  ...
  if (questionsState.questions.length < 5) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="text-center"><button type="button" class="rounded-lg p-2 px-5 font-medium text-green-500 transition duration-300 hover:text-green-300 disabled:cursor-not-allowed dark:text-green-500 dark:hover:text-green-500/50"><i class="fa-solid fa-circle-plus"></i> Add</button></div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--></div></div> <div class="flex justify-end gap-4">`;
  if (category.id) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<button type="button"${attr("disabled", loadingDelete, true)} class="mt-4 rounded-lg bg-red-300 p-2 px-5 font-medium transition duration-300 hover:bg-red-500 hover:text-white disabled:cursor-not-allowed dark:bg-red-500/50 dark:hover:bg-red-500 dark:hover:text-white">`;
    {
      $$payload.out += "<!--[!-->";
      $$payload.out += `<i class="fa-solid fa-trash"></i>`;
    }
    $$payload.out += `<!--]--> Delete</button>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <button type="submit"${attr("disabled", loadingSubmit, true)} class="mt-4 rounded-lg bg-green-300 p-2 px-5 font-medium transition duration-300 hover:bg-green-500 hover:text-white disabled:cursor-not-allowed dark:bg-green-500/50 dark:hover:bg-green-500 dark:hover:text-white">`;
  {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> Submit</button></div></div></div></form></div>`;
  pop();
}

export { _page as default };
//# sourceMappingURL=_page.svelte-jurd1hJ-.js.map
