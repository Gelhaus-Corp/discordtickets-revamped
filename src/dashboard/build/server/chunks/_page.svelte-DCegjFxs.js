import { p as push, a6 as copy_payload, a1 as ensure_array_like, b as attr, a9 as fallback, a2 as stringify, aa as slot, ab as sanitize_props, ac as spread_attributes, c as clsx, ad as add_styles, ae as merge_styles, a7 as bind_props, d as store_get, u as unsubscribe_stores, a as pop, a8 as assign_payload, n as noop } from './index-7U-6WjDo.js';
...
import { w as writable } from './exports-DdSQfVyA.js';
...
function MultiSelect($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    ...
    for (let idx = 0, $$length = each_array.length; idx < $$length; idx++) {
      ...
      $$payload2.out += `<li${attr("class", `${stringify(clsx(liSelectedClass) + " svelte-1ndgm4m")} ${stringify([drag_idx === idx ? "active" : ""].filter(Boolean).join(" "))}`)} role="option" aria-selected="true"${attr("draggable", selectedOptionsDraggable && !disabled && selected.length > 1)}${attr("style", `${stringify(get_style(option, `selected`))} ${stringify(liSelectedStyle)}`)}><!---->`;
...
//# sourceMappingURL=_page.svelte-DCegjFxs.js.map
